  ...
  public: {
    Tables: {
      ...
      fee_configs: {
        ...
        Relationships: [
          {
            foreignKeyName: "fee_configs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      pix_charges: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pix_charges_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      split_partners: {
        ...
        Relationships: [
          {
            foreignKeyName: "split_partners_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      user_owns_product: { Args: { product_id: string }; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
